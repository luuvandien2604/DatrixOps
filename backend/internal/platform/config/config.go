...
func Load() (*Config, error) {
	cfg := &Config{
		...
		DatrixopsVersion:         strings.TrimSpace(getEnv("DATRIXOPS_VERSION", "1.8.45")),
		...
		EnableServiceControls:    envBoolDefault("ENABLE_SERVICE_CONTROLS", true),
		EnableReadOnlyLogs:       envBoolDefault("ENABLE_READ_ONLY_LOGS", true),
