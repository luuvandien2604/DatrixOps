...
- **Service Monitoring đa nền tảng**: Dùng systemd trên Linux, launchd trên macOS và Windows Service Control Manager. `DATRIXOPS_SERVICES` cho phép thay thế danh sách mặc định bằng các native service identifier, phân tách bởi dấu phẩy.
