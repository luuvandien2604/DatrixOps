...
8. Task `agent_update` tải và kiểm tra binary đúng OS/architecture, stage/replace binary rồi để service manager restart. Không chạy lại installer nên giữ nguyên token và service configuration.
