...
curl -fsSL https://monitor.example.com/install.sh | sudo bash -s -- \
    --agent-version 1.5.9 \
    --agent-artifact-base-url https://github.com/luuvandien2604/DatrixOps/releases/download/v1.5.9 \
...
```powershell
.\install.ps1 -ServerUrl "https://monitor.example.com" -Token "<ENROLLMENT_TOKEN>" -AgentVersion "1.5.9" -AgentArtifactBaseUrl "https://github.com/luuvandien2604/DatrixOps/releases/download/v1.5.9"
...
```powershell
.\install.ps1 -ServerUrl "https://monitor.example.com" -Token "<ENROLLMENT_TOKEN>" -AgentVersion "1.5.9" -AgentArtifactBaseUrl "https://github.com/luuvandien2604/DatrixOps/releases/download/v1.5.9" -Services "EventLog,Schedule,WinRM"
```
